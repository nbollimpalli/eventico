...
/* harmony import */ var _event_user_register_register_component__WEBPACK_IMPORTED_MODULE_26__ = __webpack_require__(/*! ./event-user/register/register.component */ "./src/app/event-user/register/register.component.ts");
/* harmony import */ var _event_user_login_login_component__WEBPACK_IMPORTED_MODULE_27__ = __webpack_require__(/*! ./event-user/login/login.component */ "./src/app/event-user/login/login.component.ts");
/* harmony import */ var _event_user_settings_settings_component__WEBPACK_IMPORTED_MODULE_28__ = __webpack_require__(/*! ./event-user/settings/settings.component */ "./src/app/event-user/settings/settings.component.ts");
/* harmony import */ var _event_user_event_user_component__WEBPACK_IMPORTED_MODULE_29__ = __webpack_require__(/*! ./event-user/event-user.component */ "./src/app/event-user/event-user.component.ts");
...
/* harmony import */ var _events_events_component__WEBPACK_IMPORTED_MODULE_32__ = __webpack_require__(/*! ./events/events.component */ "./src/app/events/events.component.ts");
/* harmony import */ var _events_new_event_new_event_component__WEBPACK_IMPORTED_MODULE_33__ = __webpack_require__(/*! ./events/new-event/new-event.component */ "./src/app/events/new-event/new-event.component.ts");
/* harmony import */ var _event_types_event_types_component__WEBPACK_IMPORTED_MODULE_34__ = __webpack_require__(/*! ./event-types/event-types.component */ "./src/app/event-types/event-types.component.ts");
/* harmony import */ var _event_types_new_event_type_new_event_type_component__WEBPACK_IMPORTED_MODULE_35__ = __webpack_require__(/*! ./event-types/new-event-type/new-event-type.component */ "./src/app/event-types/new-event-type/new-event-type.component.ts");
/* harmony import */ var _event_venues_event_venues_component__WEBPACK_IMPORTED_MODULE_36__ = __webpack_require__(/*! ./event-venues/event-venues.component */ "./src/app/event-venues/event-venues.component.ts");
/* harmony import */ var _event_venues_new_event_venue_new_event_venue_component__WEBPACK_IMPORTED_MODULE_37__ = __webpack_require__(/*! ./event-venues/new-event-venue/new-event-venue.component */ "./src/app/event-venues/new-event-venue/new-event-venue.component.ts");
/* harmony import */ var _form_dialog_form_dialog_component__WEBPACK_IMPORTED_MODULE_38__ = __webpack_require__(/*! ./form-dialog/form-dialog.component */ "./src/app/form-dialog/form-dialog.component.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
    ...
    AppModule = __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [
                ...
                _event_user_register_register_component__WEBPACK_IMPORTED_MODULE_26__["RegisterComponent"],
                ...
                _events_events_component__WEBPACK_IMPORTED_MODULE_32__["EventsComponent"],
                _event_user_login_login_component__WEBPACK_IMPORTED_MODULE_27__["LoginComponent"],
                _events_new_event_new_event_component__WEBPACK_IMPORTED_MODULE_33__["NewEventComponent"],
                _event_types_event_types_component__WEBPACK_IMPORTED_MODULE_34__["EventTypesComponent"],
                _event_types_new_event_type_new_event_type_component__WEBPACK_IMPORTED_MODULE_35__["NewEventTypeComponent"],
                _event_venues_event_venues_component__WEBPACK_IMPORTED_MODULE_36__["EventVenuesComponent"],
                _event_venues_new_event_venue_new_event_venue_component__WEBPACK_IMPORTED_MODULE_37__["NewEventVenueComponent"],
                _form_dialog_form_dialog_component__WEBPACK_IMPORTED_MODULE_38__["FormDialogComponent"],
                _event_user_settings_settings_component__WEBPACK_IMPORTED_MODULE_28__["SettingsComponent"],
                _event_user_event_user_component__WEBPACK_IMPORTED_MODULE_29__["EventUserComponent"],
            ],
            imports: [
...
var NewEventVenueComponent = /** @class */ (function () {
    ...
    NewEventVenueComponent.prototype.setupEventVenue = function (id) {
        ...
        if (id != null && id != '' && id != "undefined") {
            ...
            this.mode = "new";
            this.eventVenue = new _shared_event_venue_model__WEBPACK_IMPORTED_MODULE_1__["EventVenue"]({});
...
var EventVenue = /** @class */ (function () {
    function EventVenue(eventVenueJsonObject) {
        ...
        this.eventVenueLayout = new _shared_event_venue_layout_model__WEBPACK_IMPORTED_MODULE_0__["EventVenueLayout"](eventVenueJsonObject["layout"]);
    }
...
var EventVenueService = /** @class */ (function () {
    ...
    EventVenueService.prototype.makeEventVenueObject = function (data) {
        ...
        var eventVenue = new _event_venue_model__WEBPACK_IMPORTED_MODULE_1__["EventVenue"](EventVenueJsonObject);
        return eventVenue;
    };
...
var NewEventComponent = /** @class */ (function () {
    ...
    NewEventComponent.prototype.setupEvent = function (id) {
        ...
        if (id != null && id != '' && id != "undefined") {
            ...
            this.mode = "new";
            this.event = new _shared_event_model__WEBPACK_IMPORTED_MODULE_1__["Event"]({});
...
var Event = /** @class */ (function () {
    ...
    Event.prototype.import = function (eventJsonObject) {
        ...
        this.eventLayout = new _shared_event_layout_model__WEBPACK_IMPORTED_MODULE_0__["EventLayout"](eventJsonObject["layout"]);
    };
...
var EventService = /** @class */ (function () {
    ...
    EventService.prototype.syncUIEvents = function (data) {
        ...
        for (var i = 0; i < eventList.length; i++) {
            ...
            var event = new _event_model__WEBPACK_IMPORTED_MODULE_1__["Event"](eventJsonObject);
